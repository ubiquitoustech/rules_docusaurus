...
case "${machine}" in
  ...
  darwin) readonly platform_main_manifest="TEMPLATED_npm_path/@docusaurus/core/bin/docusaurus.js" ;;
  windows) readonly platform_main_manifest="TEMPLATED_npm_path/@docusaurus/core/bin/docusaurus.js" ;;
  *) readonly platform_main_manifest="TEMPLATED_npm_path/@docusaurus/core/bin/docusaurus.js" ;;
esac
